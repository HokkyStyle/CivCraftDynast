 ...
 * the property of dynast LLC and its suppliers,
 * if any. The intellectual and technical concepts contained
 * herein are proprietary to dynast LLC
...
import com.dynast.civcraft.command.admin.AdminTownCommand;
...
import com.dynast.civcraft.event.GoodieRepoEvent;
...
import com.dynast.civcraft.lorestorage.LoreStoreage;
...
import com.dynast.civcraft.populators.MobSpawnerPopulator;
...
import com.dynast.civcraft.structure.ArrowTower;
...
import com.dynast.civcraft.tasks.TradeGoodSignCleanupTask;
import com.dynast.civcraft.template.Template;
import com.dynast.civcraft.template.TemplateStream;
import com.dynast.civcraft.threading.TaskMaster;
import com.dynast.civcraft.threading.timers.DailyTimer;
import com.dynast.civcraft.tutorial.CivTutorial;
import com.dynast.civcraft.util.AsciiMap;
...
public class DebugCommand extends CommandBase {
	...
	public void init() {
		...
		commands.put("ruingenerate", "Start generating ruins.");
	}
...
//	}
	...
	public void ruingenerate_cmd() throws CivException {
		String playerName;
		...
		CivMessage.send(sender, "Starting Ruin Generation task...");
		TaskMaster.asyncTask(new RuinPostGenTask(playerName, 0), 0);
