...
import com.dynast.civcraft.components.SignSelectionActionInterface;
import com.dynast.civcraft.components.SignSelectionComponent;
import com.dynast.civcraft.config.CivSettings;
import com.dynast.civcraft.config.ConfigStableHorse;
import com.dynast.civcraft.config.ConfigStableItem;
...
public class Stable extends Structure {
	...
	private HashMap<Integer, SignSelectionComponent> signSelectors = new HashMap<>();
	...
	//private static Map<ChunkCoord, Stable> stableChunks = new ConcurrentHashMap<>();
...
/*	private void bindStableChunks() {
	...
	private void unbindStableChunks() {
	...
	public void loadSettings() {
		...
		class buyHorseAction implements SignSelectionActionInterface {
			...
			private buyHorseAction(int horse_id, double cost) {
		...
		class buyItemAction implements SignSelectionActionInterface {
			...
			private buyItemAction(int item_id, double cost) {
