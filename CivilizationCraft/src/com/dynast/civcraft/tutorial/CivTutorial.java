...
public class CivTutorial {
	...
	public static void showTutorialInventory(Player player) {	
		if (tutorialInventory == null) {
			...
			tutorialInventory.addItem(LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_workbench_heading"), ItemManager.getId(Material.CRAFTING_TABLE), 0,
			...
			tutorialInventory.addItem(LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_Fence_heading"), ItemManager.getId(Material.OAK_FENCE), 0,
			...
			tutorialInventory.addItem(LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_goldHelmet_heading"), ItemManager.getId(Material.GOLDEN_HELMET), 0,
			...
			if (CivGlobal.isCasualMode()) {
				tutorialInventory.addItem(LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_firework_heading"), ItemManager.getId(Material.FIREWORK_ROCKET), 0,
			...
			tutorialInventory.setItem(8, LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_bookAndQuill_heading"), ItemManager.getId(Material.WRITTEN_BOOK), 0,
			...
			tutorialInventory.setItem(9, LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_campQuest_heading"), ItemManager.getId(Material.WRITTEN_BOOK), 0,
			...
			tutorialInventory.setItem(10, LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_civQuest_heading"), ItemManager.getId(Material.WRITTEN_BOOK), 0,
			...
			tutorialInventory.setItem(11, LoreGuiItem.build(CivColor.LightBlue+ChatColor.BOLD+CivSettings.localize.localizedString("tutorial_needRecipe_heading"), ItemManager.getId(Material.CRAFTING_TABLE), 0,
