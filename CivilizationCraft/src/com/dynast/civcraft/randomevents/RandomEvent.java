...
import com.dynast.civcraft.randomevents.components.HammerRate;
import com.dynast.civcraft.randomevents.components.Happiness;
import com.dynast.civcraft.randomevents.components.Unhappiness;
...
public class RandomEvent extends SQLObject {
	...
	private void loadSavedMessages(String input) {
		...
		for (String encodedMessage : messages) {
			...
			this.savedMessages.add(CivMessage.retransliteString(encodedMessage));
		}
	}
	...
	private String getSavedMessagesSaveString() {
		...
		for (String message : this.savedMessages) {
			if (!org.apache.commons.lang3.StringUtils.isAsciiPrintable(message) || !org.apache.commons.lang3.StringUtils.isAlpha(message)) {
				message = CivMessage.transliteString(message);
			}
	...
	public void buildComponents() {
		buildComponents("com.dynast.civcraft.randomevents.components.", configRandomEvent.actions, actions);
		buildComponents("com.dynast.civcraft.randomevents.components.", configRandomEvent.requirements, requirements);		
		buildComponents("com.dynast.civcraft.randomevents.components.", configRandomEvent.success, success);		
		buildComponents("com.dynast.civcraft.randomevents.components.", configRandomEvent.failure, failure);		
	}
