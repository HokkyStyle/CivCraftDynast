...
import com.dynast.civcraft.structure.MobGrinder;
import com.dynast.civcraft.structure.MobGrinder.Crystal;
			...
			for(ItemStack stack : contents) {
				...
				if (itemID.contains("_egg_4")) {				
					...
					if (rand1 < ((int)((mobGrinder.getMineralChance(Crystal.BIGPACK))*10000))) {
						...
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_metallic_crystal_1"),3));
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_ionic_crystal_1"),3));
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_metallic_crystal_2"),3));
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_ionic_crystal_2"),3));
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_metallic_crystal_3"),3));
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_ionic_crystal_3"),3));
						...
						if (itemID.contains("creeper")) {
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_tungsten_shield")));
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_tungsten_poleax")));
						...
						} else if (itemID.contains("rabbit")) {
						...
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_ionic_crystal_4"),1));
						newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_metallic_crystal_4"),1));
					...
					if (rand1 < ((int)((mobGrinder.getMineralChance(Crystal.BIGPACK))*10000))) {
						...
						if (itemID.contains("creeper")) {
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_enderman_egg_4"), 2));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carbide_steel_poleax")));
						} else if (itemID.contains("pig")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_pig_egg_4"), 2));
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_rabbit_egg_4"), 2));
						...
						if (itemID.contains("creeper")) {
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carbide_steel_boots")));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carbide_steel_shield")));
						} else if (itemID.contains("slime")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carbide_steel_sword")));
						} else if (itemID.contains("enderman")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carbide_steel_poleax")));
					...
					if (rand1 < ((int)((mobGrinder.getMineralChance(Crystal.BIGPACK))*10000))) {
						...
						if (itemID.contains("creeper")) {
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_enderman_egg_3"), 2));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_steel_poleax")));
						} else if (itemID.contains("pig")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_pig_egg_3"), 2));
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_rabbit_egg_3"), 2));
					...
					if (rand1 < ((int)((mobGrinder.getMineralChance(Crystal.BIGPACK))*10000))) {
						...
						if (itemID.contains("creeper")) {
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_enderman_egg_2"), 2));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_iron_poleax")));
						} else if (itemID.contains("pig")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_pig_egg_2"), 2));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carved_leather_leggings")));
						} else if (itemID.contains("cow")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_cow_egg_2"), 2));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carved_leather_chestplate")));
						} else if (itemID.contains("chicken")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_chicken_egg_2"), 2));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carved_leather_helmet")));
						} else if (itemID.contains("sheep")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_sheep_egg_2"), 2));
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_carved_leather_boots")));
						} else if (itemID.contains("rabbit")) {
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_rabbit_egg_2"), 2));
