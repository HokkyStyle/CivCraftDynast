...
import com.dynast.civcraft.config.ConfigTradeShipLevel;
...
import com.dynast.civcraft.structure.TradeShip;
...
public class TradeLevelComponent extends Component {
	 ...
	 */
	private HashMap<Integer, Integer> consumptions = new HashMap<>();
	...
	private HashMap<Integer, Double> culture = new HashMap<>();
	...
	private String getKey() {
		return getBuildable().getConfigId() + ":" + getBuildable().getId()
				+ ":" + "levelcount";
	}
			...
			if (rand1 < (int)(HUGEPACK_CHANCE*MaxRand)) {
				if (itemID.contains("_egg")) {
					if (itemID.contains("_egg_4")) {
						...
						}  else if (itemID.contains("pig") || itemID.contains("cow") || itemID.contains("chicken") || itemID.contains("sheep") || itemID.contains("rabbit")) {
				...
				if (itemID.contains("_egg")) {
					if (itemID.contains("_egg_4")) {
						...
						if (itemID.contains("creeper") || itemID.contains("skeleton") || itemID.contains("spider") || itemID.equals("zombie") || itemID.contains("slime") || itemID.contains("enderman")) {
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_steel_shield")));
						}  else if (itemID.contains("pig") || itemID.contains("cow") || itemID.contains("chicken") || itemID.contains("sheep") || itemID.contains("rabbit")) {
						...
						if (itemID.contains("creeper") || itemID.contains("skeleton") || itemID.contains("spider") || itemID.equals("zombie") || itemID.contains("slime") || itemID.contains("enderman")) {
							...
							newItems.add(LoreMaterial.spawn(LoreMaterial.materialMap.get("mat_iron_shield")));
						}  else if (itemID.contains("pig") || itemID.contains("cow") || itemID.contains("chicken") || itemID.contains("sheep") || itemID.contains("rabbit")) {
