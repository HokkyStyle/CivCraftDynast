...
import com.dynast.civcraft.components.SifterComponent;
import com.dynast.civcraft.config.CivSettings;
import com.dynast.civcraft.config.ConfigCampLonghouseLevel;
...
import com.dynast.civcraft.items.components.Tagged;
...
import com.dynast.civcraft.threading.tasks.PostBuildSyncTask;
...
public class Camp extends Buildable {
	...
	public Camp(Resident owner, String name, Location corner) throws CivException {
		...
		nextRaidDate.setTime(nextRaidDate.getTime() + 22*60*60*1000);
		...
		for (BlockCoord relativeCoord : tpl.commandBlockRelativeLocations) {
			...
			case "/gardensign":
				if (!this.gardenEnabled) {
					...
					sign.setLine(0, "Огород");
					sign.setLine(1, "Не куплен");
					sign.setLine(2, "Купить:");
			...
			case "/putbread":
				...
				Sign signb = (Sign)absCoord.getBlock().getState();
				signb.setLine(0, CivSettings.localize.localizedString("putbread0"));
				signb.setLine(1, CivSettings.localize.localizedString("putbread1"));
				signb.setLine(2, CivSettings.localize.localizedString("putbread2"));
				signb.setLine(3, CivSettings.localize.localizedString("putbread3"));
				signb.update();

				this.addCampBlock(new BlockCoord(absCoord));
				break;
			case "/saveec":
				Integer ids = Integer.valueOf(sb.keyvalues.get("id"));
				...
				switch (ids) {
					case 0:
						...
						Sign signs = (Sign)absCoord.getBlock().getState();
						signs.setLine(0, CivSettings.localize.localizedString("saveec0"));
						signs.setLine(1, CivSettings.localize.localizedString("saveec1"));
						signs.setLine(2, CivSettings.localize.localizedString("saveec2"));
						signs.setLine(3, CivSettings.localize.localizedString("saveec3"));
						signs.update();
					...
					case 1:
						...
						Sign signs1 = (Sign)absCoord.getBlock().getState();
						signs1.setLine(0, CivSettings.localize.localizedString("saveec0_1"));
						signs1.setLine(1, CivSettings.localize.localizedString("saveec1_1"));
						signs1.setLine(2, CivSettings.localize.localizedString("saveec2_1"));
						signs1.setLine(3, CivSettings.localize.localizedString("saveec3_1"));
						signs1.update();
					...
					case 2:
						...
						Sign signs2 = (Sign)absCoord.getBlock().getState();
						signs2.setLine(0, CivSettings.localize.localizedString("raidec0"));
						signs2.setLine(1, CivSettings.localize.localizedString("raidec1"));
						signs2.setLine(2, CivSettings.localize.localizedString("raidec2"));
						signs2.setLine(3, CivSettings.localize.localizedString("raidec3"));
						signs2.update();
					...
					case 3:
						...
						Sign signs3 = (Sign)absCoord.getBlock().getState();
						signs3.setLine(0, CivSettings.localize.localizedString("raidec0_1"));
						signs3.setLine(1, CivSettings.localize.localizedString("raidec1_1"));
						signs3.setLine(2, CivSettings.localize.localizedString("raidec2_1"));
						signs3.setLine(3, CivSettings.localize.localizedString("raidec3_1"));
						signs3.update();
				...
				break;
			case "/raidinfo":
				Integer idr = Integer.valueOf(sb.keyvalues.get("id"));
				...
				switch (idr) {
					case 0:
						...
						Sign signr = (Sign)absCoord.getBlock().getState();
						signr.setLine(0, CivSettings.localize.localizedString("raidinfo0"));
						signr.setLine(1, CivSettings.localize.localizedString("raidinfo1"));
						signr.setLine(2, CivSettings.localize.localizedString("raidinfo2"));
						signr.setLine(3, CivSettings.localize.localizedString("raidinfo3"));
						signr.update();
					...
					case 1:
						...
						Sign signr1 = (Sign)absCoord.getBlock().getState();
						signr1.setLine(0, CivSettings.localize.localizedString("raidinfo0_1"));
						signr1.setLine(1, CivSettings.localize.localizedString("raidinfo1_1"));
						signr1.setLine(2, CivSettings.localize.localizedString("raidinfo2_1"));
						signr1.setLine(3, CivSettings.localize.localizedString("raidinfo3_1"));
						signr1.update();
					...
					case 2:
						...
						Sign signr2 = (Sign)absCoord.getBlock().getState();
						signr2.setLine(0, CivSettings.localize.localizedString("raidinfo0_2"));
						signr2.setLine(1, CivSettings.localize.localizedString("raidinfo1_2"));
						signr2.setLine(2, CivSettings.localize.localizedString("raidinfo2_2"));
						signr2.setLine(3, CivSettings.localize.localizedString("raidinfo3_2"));
						signr2.update();
					...
					case 3:
						...
						Sign signr3 = (Sign)absCoord.getBlock().getState();
						signr3.setLine(0, CivSettings.localize.localizedString("raidinfo0_3"));
						signr3.setLine(1, CivSettings.localize.localizedString("raidinfo1_3"));
						signr3.setLine(2, CivSettings.localize.localizedString("raidinfo2_3"));
						signr3.setLine(3, CivSettings.localize.localizedString("raidinfo3_3"));
						signr3.update();
				...
				break;
			case "/campinfo":
				Integer idc = Integer.valueOf(sb.keyvalues.get("id"));
				...
				switch (idc) {
					case 0:
						...
						Sign signc = (Sign)absCoord.getBlock().getState();
						signc.setLine(0, CivSettings.localize.localizedString("campinfo0"));
						signc.setLine(1, CivSettings.localize.localizedString("campinfo1"));
						signc.setLine(2, CivSettings.localize.localizedString("campinfo2"));
						signc.setLine(3, CivSettings.localize.localizedString("campinfo3"));
						signc.update();
					...
					case 1:
						...
						Sign signc1 = (Sign)absCoord.getBlock().getState();
						signc1.setLine(0, CivSettings.localize.localizedString("campinfo0_1"));
						signc1.setLine(1, CivSettings.localize.localizedString("campinfo1_1"));
						signc1.setLine(2, CivSettings.localize.localizedString("campinfo2_1"));
						signc1.setLine(3, CivSettings.localize.localizedString("campinfo3_1"));
						signc1.update();
					...
					case 2:
						...
						Sign signc2 = (Sign)absCoord.getBlock().getState();
						signc2.setLine(0, CivSettings.localize.localizedString("campinfo0_2"));
						signc2.setLine(1, CivSettings.localize.localizedString("campinfo1_2"));
						signc2.setLine(2, CivSettings.localize.localizedString("campinfo2_2"));
						signc2.setLine(3, CivSettings.localize.localizedString("campinfo3_2"));
						signc2.update();
					...
					case 3:
						...
						Sign signc3 = (Sign)absCoord.getBlock().getState();
						signc3.setLine(0, CivSettings.localize.localizedString("campinfo0_3"));
						signc3.setLine(1, CivSettings.localize.localizedString("campinfo1_3"));
						signc3.setLine(2, CivSettings.localize.localizedString("campinfo2_3"));
						signc3.setLine(3, CivSettings.localize.localizedString("campinfo3_3"));
						signc3.update();
				...
				break;
			case "/definfo":
				Integer idd = Integer.valueOf(sb.keyvalues.get("id"));
				...
				switch (idd) {
					case 0:
						...
						Sign signc = (Sign)absCoord.getBlock().getState();
						signc.setLine(0, CivSettings.localize.localizedString("definfo0"));
						signc.setLine(1, CivSettings.localize.localizedString("definfo1"));
						signc.setLine(2, CivSettings.localize.localizedString("definfo2"));
						signc.setLine(3, CivSettings.localize.localizedString("definfo3"));
						signc.update();
					...
					case 1:
						...
						Sign signc1 = (Sign)absCoord.getBlock().getState();
						signc1.setLine(0, CivSettings.localize.localizedString("definfo0_1"));
						signc1.setLine(1, CivSettings.localize.localizedString("definfo1_1"));
						signc1.setLine(2, CivSettings.localize.localizedString("definfo2_1"));
						signc1.setLine(3, CivSettings.localize.localizedString("definfo3_1"));
						signc1.update();
					...
					case 2:
						...
						Sign signc2 = (Sign)absCoord.getBlock().getState();
						signc2.setLine(0, CivSettings.localize.localizedString("definfo0_2"));
						signc2.setLine(1, CivSettings.localize.localizedString("definfo1_2"));
						signc2.setLine(2, CivSettings.localize.localizedString("definfo2_2"));
						signc2.setLine(3, CivSettings.localize.localizedString("definfo3_2"));
						signc2.update();
					...
					case 3:
						...
						Sign signc3 = (Sign)absCoord.getBlock().getState();
						signc3.setLine(0, CivSettings.localize.localizedString("definfo0_3"));
						signc3.setLine(1, CivSettings.localize.localizedString("definfo1_3"));
						signc3.setLine(2, CivSettings.localize.localizedString("definfo2_3"));
						signc3.setLine(3, CivSettings.localize.localizedString("definfo3_3"));
						signc3.update();
	...
	public void processLonghouse() {
		...
		if (craftMat != null) {
			...
			token = tag.addTag(token, res.getUUIDString()+getId());
	...
	public void fancyCampBlockDestory() {
		for (BlockCoord coord : this.campBlocks.keySet()) {
			...
			if (rand.nextInt(100) <= 1) {
				FireworkEffect effect = FireworkEffect.builder().with(org.bukkit.FireworkEffect.Type.BURST).withColor(Color.ORANGE).withColor(Color.RED).withTrail().build();
	...
	public void onControlBlockDestroy(ControlPoint cp, World world, Player player) {		
		...
		FireworkEffect effect = FireworkEffect.builder().with(org.bukkit.FireworkEffect.Type.BURST).withColor(Color.YELLOW).withColor(Color.RED).withTrail().build();
		FireworkEffectPlayer fePlayer = new FireworkEffectPlayer();
		for (int i = 0; i < 2; i++) {
			try {
	...
	public void onDamage(int amount, World world, Player player, BlockCoord hit, BuildableDamageBlock hit2) {
		...
		if (cp != null) {
			...
			if (now.after(getNextRaidDate())) {
				...
				calendar.setTime(getNextRaidDate());
	...
	public Date getNextRaidDate() {
		...
		raidEnd.setTime(this.nextRaidDate.getTime() + 3600L *1000*this.raidLength);
