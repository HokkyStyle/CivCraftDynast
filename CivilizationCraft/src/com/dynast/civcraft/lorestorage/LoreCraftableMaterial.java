...
import com.dynast.civcraft.config.ConfigIngredient;
import com.dynast.civcraft.config.ConfigMaterial;
import com.dynast.civcraft.items.components.ItemComponent;
	...
	private void buildComponents() {
		...
		if (compInfoList != null) {
			for (HashMap<String, String> compInfo : compInfoList) {
				String className = "com.dynast.civcraft.items.components."+compInfo.get("name");
				Class<?> someClass;
