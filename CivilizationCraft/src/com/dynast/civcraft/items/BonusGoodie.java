...
import com.dynast.civcraft.util.InventoryHolderStorage;
...
//		}
	...
	public String getBonusDisplayString() {
		...
		for (ConfigBuff cBuff : this.config.buffs.values()) {
			...
			out += ";";
			for (String str : cBuff.description) {
				str = CivColor.colorize(str);
				out += CivColor.White + ChatColor.ITALIC + str;
				out += ";";
			}
		}
