...
import com.dynast.civcraft.exception.InvalidBlockLocation;
import com.dynast.civcraft.util.BlockSnapshot;
...
public class CivData {
	...
	public static final short VILLAGER_EGG_DATA = 120;
	...
	public static final int WHITE_CLAY = 0;
	public static final int ORANGE_CLAY = 1;
	public static final int LIGHTPURPLE_CLAY = 2;
	public static final int LIGHTBLUE_CLAY = 3;
	public static final int YELLOW_CLAY = 4;
	public static final int LIME_CLAY = 5;
	public static final int ROSE_CLAY = 6;
	public static final int GRAY_CLAY = 7;
	public static final int LIGHTGRAY_CLAY = 8;
	public static final int BIRUZE_CLAY = 9;
	public static final int PURPLE_CLAY = 10;
	public static final int BLUE_CLAY = 11;
	public static final int BROWN_CLAY = 12;	
	public static final int GREEN_CLAY = 13;
	public static final int RED_CLAY = 14;
	public static final int BLACK_CLAY = 15;
	
	public static final int SANDSTONE_COMMON = 0;
	public static final int SAND = 12;
	public static final int SHIELD = 442;
	public static final int SHULKER_BOX = 219;
...
//	}
	...
	public static boolean isShulker(Material mat) {
		return mat.equals(Material.BLACK_SHULKER_BOX) ||
				mat.equals(Material.BLUE_SHULKER_BOX) ||
				mat.equals(Material.BROWN_SHULKER_BOX) ||
				mat.equals(Material.CYAN_SHULKER_BOX) ||
				mat.equals(Material.GRAY_SHULKER_BOX) ||
				mat.equals(Material.GREEN_SHULKER_BOX) ||
				mat.equals(Material.LIGHT_BLUE_SHULKER_BOX) ||
				mat.equals(Material.LIME_SHULKER_BOX) ||
				mat.equals(Material.MAGENTA_SHULKER_BOX) ||
				mat.equals(Material.ORANGE_SHULKER_BOX) ||
				mat.equals(Material.PINK_SHULKER_BOX) ||
				mat.equals(Material.PURPLE_SHULKER_BOX) ||
				mat.equals(Material.WHITE_SHULKER_BOX) ||
				mat.equals(Material.YELLOW_SHULKER_BOX) ||
