...
import com.dynast.civcraft.randomevents.RandomEventTimer;
...
//		}
		...
		try {
			SpawnBossEvent bossEvent = new SpawnBossEvent();
			new EventTimer("spawnbosstimer", bossEvent, bossEvent.getNextDate());
		} catch (Exception e) {
			e.printStackTrace();
		}
